...
- 目标：最大化验证集上的 AUPRC 分数。
- 修正：始终为 LOF 设置 n_jobs=1 以避免多进程崩溃。

运行方式:
    pip install optuna
    python run_lof_optimization.py
"""
...
def load_data(path: str) -> tuple:
    ...
    try:
        ...
        print(f"请先运行 'feature_generator.py'。")
...
def main():
    ...
    print(f"最佳 AUPRC: {study.best_value:.6f}")
